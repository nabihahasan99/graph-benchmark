"""
Load IMDb graph data into Neo4j Cloud
Uses Cypher queries via Neo4j driver (Neo4j is Cypher-compatible)
"""
...
class Neo4jLoader:
    ...
    def save_stats(self, output_path):
        ...
        self.stats['database'] = 'Neo4j Cloud'
...
def main():
    ...
    # Save statistics
    loader.save_stats(results_dir / 'neo4j_loading_stats.json')
